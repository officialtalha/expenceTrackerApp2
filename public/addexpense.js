...
form.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        const result = await axios.post('http://13.233.190.235:3000/add-expense', {
        ...
        //     await axios.delete(`http://13.233.190.235:3000/add-expense/${result.data.id}`, {
        //         headers: {
...
(async () => {
    try {
        ...
        const sum = await axios.get(`http://13.233.190.235:3000/add-expense/sum-expenses`, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': token,
            }
        ...
        const result = await axios.get(`http://13.233.190.235:3000/add-expense/local/${getItemPerPage}`, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': token,
            }
        ...
        for (let i in result.data.result) {
            ...
            deleteBtn.onclick = async () => {
                await axios.delete(`http://13.233.190.235:3000/add-expense/${result.data.result[i].id}`, {
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': token,
                    }
        ...
        prevBtn2.onclick = async () => {
            ...
            const result = await axios.get(`http://13.233.190.235:3000/add-expense/${curPage}/${itemPerPage}`, {
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': token,
                }
        ...
        //premium code 
        const premiumCheck = await axios.get(`http://13.233.190.235:3000/check-premium`, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': token,
            }
        ...
        if (premiumCheck.data.result[0].isPremium == true) {
            ...
            downloadBtn.onclick = async () => {
                try {
                    const result = await axios.get(`http://13.233.190.235:3000/download`,
                        {
                            headers: {
                                'Content-Type': 'application/json',
                                'Authorization': token,
            ...
            //download links code
            const links = await axios.get(`http://13.233.190.235:3000/downloadLink`, {
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': token,
                }
            ...
            nextBtn.onclick = async () => {
                ...
                const links = await axios.get(`http://13.233.190.235:3000/downloadLink/${curPage}`, {
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': token,
                    }
            ...
            leaderBtn.onclick = async () => {
                try {
                    if (leaderboard.hasChildNodes()) {
                        ...
                        const userSum = await axios.get(`http://13.233.190.235:3000/leaderboard`, {
                            headers: {
                                'Content-Type': 'application/json',
                                'Authorization': token,
                            }
...
document.getElementById('dltAcntBtn').addEventListener('click', async (e) => {
    ...
    try {
        if (flag) {
            await axios.delete(`http://13.233.190.235:3000/dltAc`, {
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': token,
                }
...
premiumBtn.addEventListener('click', async (e) => {
    try {
        const result = await axios.get('http://13.233.190.235:3000/premium', {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': token,
            }
        ...
        var options = {
            ...
            "handler": async function (result) {
                await axios.post('http://13.233.190.235:3000/premium', {
